...
INSERT INTO `doctorlogin` (`doctorid`, `clinic_location`, `doctorname`, `doctorpassword`, `doctoremail`, `phoneno`, `speciality`, `rating`, `degree`, `experience`, `age`, `fee`, `profile`) VALUES
