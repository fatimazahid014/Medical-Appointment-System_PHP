...
<div class="container-fluid pt-2 pb-2" style="background-color:rgba(11, 59, 59,0.904);">
    <div class="row">
        <div class="col-sm-10 ">
         <a href="dashboard.php">  <img  width="150" class="ml-0 mt-2 mb-2" src="../images/MedicalCare.png"></a> 
        </div>
        <div class="col-sm-2">
		<h3 style="color:white" class="mr-0">Welcome <?php echo $doctorname ?>!</h3>
...
<div class="form-group" >
  ...
  <div class="form-group" >
    ...
    <input type="file"  name="simg" placeholder="Upload Profile image">
</div>
